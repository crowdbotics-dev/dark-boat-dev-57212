"""
Django settings for dark_boat_dev_57212 project.
...
ROOT_URLCONF = 'dark_boat_dev_57212.urls'
...
WSGI_APPLICATION = 'dark_boat_dev_57212.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_boat_dev_57212 API",
    "DESCRIPTION": "API documentation for dark_boat_dev_57212 App",
    "VERSION": "v1",
}
